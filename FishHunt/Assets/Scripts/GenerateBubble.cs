...
public class GenerateBubble : MonoBehaviour {
    ...
    void Start () {
        //All the assets are generated in the run time. These assets are at prefabs so literally, whole object is not passed through network
        //the existing prefabs is instantiated in individual players device
